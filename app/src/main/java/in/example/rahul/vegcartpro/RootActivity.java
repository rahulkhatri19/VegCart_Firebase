...
public class RootActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        allfoodData= database.getReference("AllFood/root");
            ...
            protected void populateViewHolder(MenuViewHolder viewHolder, AllFood model, int position) {
                ...
                viewHolder.setItemClickListener(new ItemClickListener() {
                    ...
                    public void onClick(View view, int position, boolean isLongClick) {
                        ...
                        mName= name+"\n"+nameHindi+"\n"+det5;
                        Toast.makeText(RootActivity.this,mName,Toast.LENGTH_SHORT).show();
                        Intent intent= new Intent(RootActivity.this, Detail.class);
