...
public class FruitActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        allfoodData= database.getReference("AllFood/fruit");
//https://vegcartpro.firebaseio.com/AllFood/fruit/01
            ...
            protected void populateViewHolder(MenuViewHolder viewHolder, AllFood model, int position) {
                ...
                viewHolder.setItemClickListener(new ItemClickListener() {
                    ...
                    public void onClick(View view, int position, boolean isLongClick) {
                        ...
                        mName= name+"\n"+nameHindi+"\n"+det5;
                        Toast.makeText(FruitActivity.this,mName,Toast.LENGTH_SHORT).show();
                        Intent intent= new Intent(FruitActivity.this, Detail.class);
