...
public class ContactActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ib1 = (ImageView) findViewById(R.id.img_btn1);
        ib2 = (ImageView) findViewById(R.id.img_btn2);
        ib3 = (ImageView) findViewById(R.id.img_btn3);
        ib4 = (ImageView) findViewById(R.id.img_btn4);
        ib5=(ImageView)findViewById(R.id.image);
