...
import in.example.rahul.vegcartpro.Model.FoodData;
...
public class FoodActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        foodData= database.getReference("FoodData");
    ...
    private void loadImages() {
        FirebaseRecyclerAdapter<FoodData, MenuViewHolder> adapter= new FirebaseRecyclerAdapter<FoodData, MenuViewHolder>(FoodData.class, R.layout.food, MenuViewHolder.class,foodData) {
            @Override
              ...
              viewHolder.setItemClickListener(new ItemClickListener() {
                  ...
                  public void onClick(View view, int position, boolean isLongClick) {
                     ...
                     //  det5=clickItem.getPrice();
                      ...
                      mName= name+"\n"+nameHindi;
                      Toast.makeText(FoodActivity.this,mName,Toast.LENGTH_SHORT).show();
                      Intent intent= new Intent(FoodActivity.this, Detail.class);
