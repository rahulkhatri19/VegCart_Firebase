...
public class LeavesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        allfoodData= database.getReference("AllFood/leaves");
            ...
            protected void populateViewHolder(MenuViewHolder viewHolder, AllFood model, int position) {
                ...
                viewHolder.setItemClickListener(new ItemClickListener() {
                    ...
                    public void onClick(View view, int position, boolean isLongClick) {
                        ...
                        mName= name+"\n"+nameHindi+"\n"+det5;
                        Toast.makeText(LeavesActivity.this,mName,Toast.LENGTH_SHORT).show();
                        Intent intent= new Intent(LeavesActivity.this, Detail.class);
